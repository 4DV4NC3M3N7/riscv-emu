...
all: terminal.o core.o memory.o device.o bus.o display.o ext_mem.o timer.o elf.o elf_tables.o graphics.o registers.o console.o log_console.o riscv_emu
...
log_console.o: graphics/log_console.h graphics/log_console.cpp
	g++ graphics/log_console.cpp $(CFLAGS) -c

riscv_emu: main.cpp terminal.o core.o memory.o device.o bus.o display.o ext_mem.o timer.o debug.h elf.o elf_tables.o graphics.o registers.o console.o log_console.o
	g++ main.cpp terminal.o memory.o core.o bus.o device.o display.o ext_mem.o timer.o elf.o elf_tables.o graphics.o registers.o  console.o log_console.o $(CFLAGS) -o riscv_emu
