...
all: terminal.o core.o memory.o device.o bus.o display.o ext_mem.o timer.o elf.o elf_tables.o graphics.o registers.o riscv_emu
...
riscv_emu: main.cpp terminal.o core.o memory.o device.o bus.o display.o ext_mem.o timer.o debug.h elf.o elf_tables.o graphics.o registers.o
	g++ main.cpp terminal.o memory.o core.o bus.o device.o display.o ext_mem.o timer.o elf.o elf_tables.o graphics.o registers.o $(CFLAGS) -o riscv_emu
